...
class GradientTableViewController: UITableViewController {
    ...
    let colors = [UIColor(red: 45/255.0, green: 0/255.0, blue: 80/255.0, alpha: 1.0).cgColor, UIColor(red: 180/255.0, green: 180/255.0, blue: 250/255.0, alpha: 1.0).cgColor] as [Any]
